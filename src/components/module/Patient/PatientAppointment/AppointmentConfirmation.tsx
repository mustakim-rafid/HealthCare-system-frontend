    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
              ...
              doctor.doctorSpeciality.length > 0 && (
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {doctor.doctorSpeciality.map((ds, idx) => (
                      <span
                        key={idx}
                        className="px-2 py-1 bg-muted text-primary text-xs rounded-md border border-blue-200"
                      >
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="bg-muted from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 space-y-4">
              <div>
